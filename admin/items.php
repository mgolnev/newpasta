...
while ($cat = mysqli_fetch_array($ath)) {
        ...
        $ath2 = mysqli_query($db,"SELECT * FROM ps_items2 WHERE cat = '".$cat['ctid']."' AND vis = 1 ORDER BY itsort;");
        ...
        while ($ci = mysqli_fetch_array($ath2)) {
             ...
             ++$i;
				...
				echo "<td><a href=\"itemedit.php?ithash=".$ci['ithash']."&visno\">Невидим</a></td>";
                echo "</tr>";
        }
